...
export const profiles: Profile[] = [
  ...
  },
  {
    ...
    role: 'Alum',
    classYear: "'60",
    quote: '"Being at Pomfret taught me that if I could be heard, understood and accepted in such a tough, challenging, male environment, I could be heard anywhere. The class of \'60 created another dimension in my life. Many of those classmates are still professional and personal friends."',
  ...
  },
  {
    ...
    role: 'Alum',
    classYear: "'74",
    quote: '"I never considered myself to be the first female Editor-in-Chief of The Pontefract — it was simply work that needed doing. I was a left-footed, slightly tone-deaf farm girl when I arrived at Pomfret, but I had the lead in musicals and played soccer."',
  ...
  },
  {
    ...
    role: 'Alum',
    classYear: "'72",
    quote: '"Pomfret expected the same of me as it did of every student — separate, equal, and just."',
  ...
  },
  {
    ...
    role: 'Alum',
    classYear: "'72",
    quote: '"As a Service family which necessitates frequent relocations, we are well aware of the importance of an environment that will academically challenge our children — Pomfret offered exactly that."',
    bio: 'Daughter of a military family whose father was on Pentagon assignment during her Pomfret years. Graduated alongside her brother Andrew \'03. Received her Master\'s degree in Regional Planning from UMASS at Amherst in 1975. Currently: Professor of Communication Disorders, Florida State University. Bachelor\'s in Linguistics and French \'76, M.S. Speech and Hearing Sciences \'78, Ph.D. University of Pittsburgh \'83.',
    yearsAtPomfret: '1968-1972',
  ...
  },
  {
    ...
    bio: 'Entered Pomfret with precocious sixth form ambitions. Her sons Andrew \'03 and Stephen \'05 later attended the school. Conference planner for teachers and young scholars in the educational psychology department at UCONN. B.S., Biology, St. Lawrence University \'76, Master of Anthropology, University of Wyoming \'83.',
    yearsAtPomfret: '1968-1972',
  ...
  },
  {
    ...
    role: 'Alum',
    classYear: "'72",
    quote: '"It\'s been great to watch Izzie flourish at Pomfret. I love knowing that the Pomfret girls of today feel that the school has always been coed. They don\'t realize that an entirely different atmosphere existed not that long ago. I think it\'s a testament to how far Pomfret School has come in establishing itself as an excellent boarding and day school for girls."',
    bio: 'Daughter of Pomfret art teacher, crew coach, and long-time legend Chick "Propeller" Cole. Beyond being a regular teenager dealing with teenage issues — studying, socializing, establishing friendships, and hoping for acceptance — she helped pave the way for later Cole-family Pomfret students, including her daughter Elizabeth "Izzie" Butch, who entered Pomfret in 2001. Later: B.A. Wheaton College \'76, M.A. Fairfield University, 2000. Marriage and Family Therapist.',
    yearsAtPomfret: '1968-1972',
  ...
  },
  {
    ...
    bio: 'Pomfret faculty 1961-1999, serving as on-site director of SPHERE (Supplementary Program in Hartford for Educational Reinforcement and Enrichment). Introduced the first true organized sport for girls at Pomfret — soccer — in the fall of 1968. Coached "Merjian\'s Maulers," the girls\' soccer team that kicked up a storm in 1974. His brand of passion for writing, drama, and public speaking were elements of his pedagogy. His dedication to the "least of these" was unparalleled.',
